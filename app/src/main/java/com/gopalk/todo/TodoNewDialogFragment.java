package com.gopalk.todo;

/**
 * Created by gopalk on 6/24/16.
 */
...
public class TodoNewDialogFragment extends DialogFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String title = getArguments().getString(ToDoActivity.KEY_TITLE,
        ...
        mPriority = TodoItem.Priority.values()[data.getInt(
                ToDoActivity.KEY_TASK_PRIO, TodoItem.Priority.PRIOROTY_MEDIUM.ordinal())];
        ...
        mId = data.getInt(ToDoActivity.KEY_ID, -1);
    }
