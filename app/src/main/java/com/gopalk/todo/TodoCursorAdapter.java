...
public class TodoCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int index = cursor.getColumnIndexOrThrow(TodoDb.KEY_TODO);
        ...
        TodoItem.Priority priority = TodoItem.Priority.values()[
                cursor.getInt(cursor.getColumnIndexOrThrow(TodoDb.KEY_PRIO))];
        ...
        String dueDate = cursor.getString(cursor.getColumnIndexOrThrow(TodoDb.KEY_DUE));
        ...
        Integer id = cursor.getInt(cursor.getColumnIndexOrThrow(TodoDb.KEY_ID));
